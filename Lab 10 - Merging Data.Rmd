...
lab_dataset_v1 <- freshman_fall %>% 
  dplyr::select(parnt6, w1q8b, w1q8e, w1q8f, w1q8g, w1q8j, w1q8k, w1q10c, w1q91a, w1q91b, w1q91c, w1q91d, w1q91e)

lab_dataset_v2 <- freshman_fall %>% 
  dplyr::select(parnt13, w1q22a, w1q22e, w1q22f, w1q22g, w1q22m, w1q22n, w1q25c, w1q91a, w1q91b, w1q91c, w1q91d, w1q91e)
...
lab_dataset_v2 <- transform(lab_dataset_v2,
                              ...
                              probfincol1yr_2 = as.numeric(probfincol1yr_2),
                              probfincol2yr_2 = as.numeric(probfincol2yr_2),
                              probfincol_2 = as.numeric(probfincol_2),
                              probextraeduc_2 = as.numeric(probextraeduc_2),
                              probfingraddeg_2 = as.numeric(probfingraddeg_2)
                              )
```
...
```{r}
left_join(freshman_dataset_v2, sex_vector, by = )

JUST USE BIG DATASET AND SLIT IT UP
right_join(freshman_dataset_v2, sex_vector)
```
