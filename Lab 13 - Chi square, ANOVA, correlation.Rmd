...
My degrees of freedom for df1 = 3 and my degrees of freedom for df2 = 3645. Df1 is calculated by taking the groups you are looking at and subtracting 1 (4-1=3) and df2 is found by taking the observations and subtracting the number of groups from it (3,649-4=3,645).
...
summary(results)
```
The test statistic from the F-table is 
